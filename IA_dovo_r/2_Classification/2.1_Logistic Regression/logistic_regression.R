#Modelo de regresión logistica para clasificacion
...
#Crear la matriz de confusion para ver el error y acierto del algoritmo 
cm <- table(testing_set[,3], y_pred)


#Visualización del conjunto de entrenammiento 
